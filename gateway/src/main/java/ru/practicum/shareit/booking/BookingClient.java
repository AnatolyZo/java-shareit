...
public class BookingClient extends BaseClient {
    private static final String API_PREFIX = "/internal/bookings";
    ...
    public ResponseEntity<Object> approveBooking(long userId, long bookingId, boolean state) {
        return patch("/" + bookingId + "?approved=" + state, userId);
    }
    ...
    public ResponseEntity<Object> getOwnersBookings(long userId, String state) {
        Map<String, Object> params = Map.of("state", state);
